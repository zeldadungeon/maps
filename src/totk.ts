...
window.onload = async () => {
    ...
    [
      {
        ...
        groupings: [
          {
            groupingName: "Creatures",
            groupingIcon: "compendium_creatures.png",
            groups: [
              {
                groupName: "Land Animals",
                objectNames: [
                  "Horse",
                  "Giant Horse",
                  "White Horse",
          ...
          {
            groupingName: "Monsters",
            groupingIcon: "compendium_monsters.png",
            groups: [],
          },
          {
            groupingName: "Materials",
            groupingIcon: "compendium_materials.png",
            groups: [
              {
                groupName: "Fruits",
                objectNames: [
          ...
          {
            groupingName: "Treasure",
            groupingIcon: "compendium_treasure.png",
            groups: [
              {
                groupName: "Ore",
                objectNames: [
          ...
          {
            groupingName: "By Cooking Effect",
            groupingIcon: "compendium_meals.png",
            groups: [
              {
  ...
  map.addLegend(
    [
      ...
      legendItem("Ascend Point", "elevator.png", 25, 25),
    ],
    "Other"
  );
  map.addLegend(
